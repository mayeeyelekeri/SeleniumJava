...
import com.mine.seleniumjava.Utility.SetupMainPageFirefox;
...
public class HerokuMainPageTestFirefox {
	
	SetupMainPageFirefox mainPage; 
	WebDriver driver; 
	...
	public void beforeTest() {
		...
		mainPage = new SetupMainPageFirefox(); 
